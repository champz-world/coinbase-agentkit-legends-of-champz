...
- Rewards are claimable on-chain via signed vouchers (no gas needed from your agent)
...
7. loc_get_claims         → collect signed reward vouchers after cycle ends
8. Execute claim on-chain → call reward contract with nonce + signature
```
